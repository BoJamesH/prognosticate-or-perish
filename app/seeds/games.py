...
# def seed_games():
    # example_game_1 = Game(week=5, year=2023, home_team_=1, away_team_id=10, home_spread=-2.5, away_spread=2.5, home_spread_odds=-109, away_spread_odds=-109, over_under=40.5, under_odds=-109, over_odds=-109)
